...
docker build --no-cache -t docker.wso2.com/wso2-cloud/custom:dind-base -f $CURRENT_DIR/custom/base/Dockerfile.docker-in-docker-base-image $CURRENT_DIR/custom/base/
