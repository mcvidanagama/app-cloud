 ...
 * under the License.
 */
package org.wso2.appcloud.httpgetprocessor.extensions.swagger.processors.yaml;
...
/**
 * Processes incoming http request and provide Swagger definition for the API in YAML format
 */
public class SwaggerYamlProcessor implements HttpGetRequestProcessor {
    ...
    /**
     * Process incoming CarbonHttpRequest and update CarbonHttpResponse with generated swagger definition in yaml
     * format
     *
    ...
    public void process(CarbonHttpRequest request, CarbonHttpResponse response,
        ...
        if (api == null) {
            ...
            SwaggerUtils.updateResponse(response, responseString, SwaggerConstants.CONTENT_TYPE_YAML);
        }
    }
}
