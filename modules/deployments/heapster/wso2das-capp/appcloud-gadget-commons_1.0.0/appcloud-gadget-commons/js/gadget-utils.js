...
/**
 * This Javascript module groups utility methods that are being used by all the gadgets in the app cloud operational dashboard
 */

var CONTEXT = "/portal/store/carbon.super/fs/gadget/appcloud-gadget-commons/api/appcloud-monitoring.jag";
...
function GadgetUtil() {
    var DEFAULT_START_TIME = new Date(moment().subtract(30, 'minutes')).getTime();
