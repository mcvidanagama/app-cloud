...
public class DBUtil {
    ...
    static final String DB_URL = "jdbc:mysql://localhost/AppCloudDB";

    public static Connection getDBConnection() throws AppCloudMeteringException {
        ...
        try {
            ...
            throw new AppCloudMeteringException(msg, e);
