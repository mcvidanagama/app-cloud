...
function populateDatatable() {
  usersDatatable = $('.datatable table').dataTable({
            ...
            'ajax': {
                "type"   : "POST",
                "url"    : '../blocks/database/add/ajax/add.jag',
                "data"   : function( d ) {
            ...
            "fnDrawCallback": function( oSettings ) {
                ...
                $('.switch input[type=checkbox]').on("click",function(){
                    ...
                    if(isChecked){
                            attachUserWithPermissions(userName);
                     }else {
...
*/
function attachUserWithPermissions(userName) {
    if(userName) {
        jagg.post("../blocks/database/add/ajax/add.jag", {
...
function deleteUser(userName) {
        jagg.post("../blocks/database/users/ajax/list.jag", {
            action:"deleteUser",
            name:userName
        },function (result) {
            usersDatatable.api().ajax.reload();
