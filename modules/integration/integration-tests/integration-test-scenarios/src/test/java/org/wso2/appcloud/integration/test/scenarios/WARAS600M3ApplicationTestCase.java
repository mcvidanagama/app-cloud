...
public class WARAS600M3ApplicationTestCase extends AppCloudIntegrationBaseTestCase {

	private static final Log log = LogFactory.getLog(WARAS600M3ApplicationTestCase.class);
    ...
    public WARAS600M3ApplicationTestCase() {
        super(AppCloudIntegrationTestUtils.getPropertyValue(AppCloudIntegrationTestConstants.TOMCAT_AS600M3_APP_RUNTIME_ID_KEY),
