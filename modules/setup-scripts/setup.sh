...
function as_setup(){
    ...
    cp $APP_CLOUD_SRC_HOME/modules/extensions/org.wso2.appcloud.esb.integration/ContainerAPICompositeApplication/target/ContainerAPICompositeApplication_3.0.0-SNAPSHOT.car $APP_CLOUD_SRC_HOME/modules/resources/dockerfile/wso2esb/base/5.0.0/carbonapps/
    cp $APP_CLOUD_SRC_HOME/modules/extensions/org.wso2.appcloud.tenant.initializer/target/org.wso2.appcloud.tenant.initializer-3.0.0-SNAPSHOT.jar $APP_CLOUD_SRC_HOME/modules/resources/dockerfile/wso2esb/base/5.0.0/dropins/
    cp $APP_CLOUD_SRC_HOME/modules/extensions/org.wso2.appcloud.httpgetprocessor.extensions/target/org.wso2.appcloud.httpgetprocessor.extensions-3.0.0-SNAPSHOT.jar $APP_CLOUD_SRC_HOME/modules/resources/dockerfile/wso2esb/base/5.0.0/lib/
